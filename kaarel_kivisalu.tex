...
\pealkiri{Gravitatsiooni mõju erinevate kvantmehaaniliste süsteemide soojusmahtuvusele}
...
Mõlema lahendusega saadi samasugune seos kera soojusmahtuvuse ja lineaarse soojuspaisumisteguri vahel. %tulemus ja seoti omavahel kera soojusmahtuvuse ja lineaarse soojuspaisumisteguri.
...
Üldiselt on $\psi$ kompleksfunktsioon, mida saab avaldada klassikalises piirkonnas amplituudi $A(x)$ ja faasi $\phi(x)$ kaudu, mis mõlemad on reaalarvulised \parencite[316]{griffiths05}:
\begin{equation}
...
In this study approximate relationships was found for the heat capacity of two different quantum-mechanical systems in gravitational field.
This study used a model with one free particle in one dimension and the rest of the particles fixed.
In this study perturbed quantum harmonic oscillator was examined by the perturbation theory and partially linear potential was examined quasi-classically broken.

For the linear potential of the piece, it was found that the heat capacity can both decrease and increase as the strength of the gravity field increases.
For the potential of a cubic-quantum mechanical harmonic oscillator, the formula was found for heat capacity, but no final conclusion could be drawn.
The results obtained were compared with the heat capacity of the previously studied sphere in the gravitational field.
